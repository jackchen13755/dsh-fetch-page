...
if [ -z "$CHECKOUT" ]; then
  for candidate in "$HOME/Desktop/work/deepseek-harness" "$HOME/dsh-harness" "$HOME/dsh" "$HOME/.dsh/dsh-harness"; do
...
link_pkg @deepseek-ai/dsh-shell packages/shell/shell
